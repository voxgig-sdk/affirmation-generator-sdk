// Command AffirmationGenerator-mcp is an MCP server exposing the AffirmationGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AffirmationGenerator_list  — list records of an entity
//	AffirmationGenerator_load  — load a single record of an entity
//
