...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_random_affirmation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AffirmationGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "affirmation-generator_list",
		Description: "List records from AffirmationGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "affirmation-generator_load",
		Description: "Load a single record from AffirmationGenerator. " +
...
func runOp(client *sdk.AffirmationGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AffirmationGeneratorSDK, name string) (sdk.AffirmationGeneratorEntity, error) {
	switch strings.ToLower(name) {
	case "get_random_affirmation":
		return client.GetRandomAffirmation(nil), nil
