...
|---|---|---|
| `ts/` | @voxgig-sdk/affirmation-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/affirmation-generator-sdk \
      --repository voxgig-sdk/affirmation-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/affirmation-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/affirmation-generator-sdk --id=<id>` removes it.
