...
// AffirmationGenerator SDK utility type

class AffirmationGeneratorUtility
{
    ...
    public static function copy(AffirmationGeneratorUtility $src): AffirmationGeneratorUtility
    {
        $u = new AffirmationGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
