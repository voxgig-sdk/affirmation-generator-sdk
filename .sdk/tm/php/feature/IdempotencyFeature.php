...
// AffirmationGenerator SDK idempotency feature
...
class AffirmationGeneratorIdempotencyFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _mutating(AffirmationGeneratorContext $ctx): bool
    {
