...
// AffirmationGenerator SDK telemetry feature
...
class AffirmationGeneratorTelemetryFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _close(AffirmationGeneratorContext $ctx, bool $ok): void
    {
