...
// AffirmationGenerator SDK clienttrack feature
...
class AffirmationGeneratorClienttrackFeature extends AffirmationGeneratorBaseFeature
{
    ...
    public function PostConstruct(AffirmationGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AffirmationGenerator-SDK';
