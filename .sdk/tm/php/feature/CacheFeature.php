...
// AffirmationGenerator SDK cache feature
...
class AffirmationGeneratorCacheFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _through(AffirmationGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
