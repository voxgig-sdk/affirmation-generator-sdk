...
// AffirmationGenerator SDK timeout feature
...
class AffirmationGeneratorTimeoutFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _with_timeout(AffirmationGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AffirmationGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
