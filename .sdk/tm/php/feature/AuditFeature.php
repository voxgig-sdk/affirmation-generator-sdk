...
// AffirmationGenerator SDK audit feature
...
class AffirmationGeneratorAuditFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _emit(AffirmationGeneratorContext $ctx, string $outcome): void
    {
