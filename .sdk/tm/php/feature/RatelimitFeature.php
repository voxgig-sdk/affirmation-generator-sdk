...
// AffirmationGenerator SDK ratelimit feature
...
class AffirmationGeneratorRatelimitFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _acquire(AffirmationGeneratorContext $ctx): void
    {
    ...
    private function _track(AffirmationGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
