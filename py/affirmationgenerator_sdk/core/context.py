...
from affirmationgenerator_sdk.core.helpers import get_ctx_prop, to_map
...
class AffirmationGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = AffirmationGeneratorControl()
        ...
        if isinstance(sp, AffirmationGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AffirmationGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AffirmationGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return AffirmationGeneratorOperation({})
    ...
    def make_error(self, code, msg):
        return AffirmationGeneratorError(code, msg, self)
