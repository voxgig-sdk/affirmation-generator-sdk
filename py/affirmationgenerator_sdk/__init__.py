...
from affirmationgenerator_sdk.utility import register

# Load features
from affirmationgenerator_sdk.feature.base_feature import AffirmationGeneratorBaseFeature
from affirmationgenerator_sdk.features import _has_feature, _make_feature
...
class AffirmationGeneratorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AffirmationGeneratorUtility()
        self._utility = utility

        from affirmationgenerator_sdk.config import shared_config
    ...
    def get_utility(self):
        return AffirmationGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AffirmationGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetRandomAffirmation(self, data=None) -> "GetRandomAffirmationEntity":
        ...
        from affirmationgenerator_sdk.entity.get_random_affirmation_entity import GetRandomAffirmationEntity
