...
from affirmationgenerator_sdk.affirmationgenerator_types import (
...
class GetRandomAffirmationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomAffirmationEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomAffirmation:
    ...
    def match_get(self) -> GetRandomAffirmation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetRandomAffirmation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetRandomAffirmation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
