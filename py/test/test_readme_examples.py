# AffirmationGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AffirmationGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AffirmationGeneratorSDK(...) and AffirmationGeneratorSDK.test(...) become
#      AffirmationGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "affirmationgenerator_sdk"
_SDK_CLASS = "AffirmationGeneratorSDK"
...
_ENTITIES = {
    "GetRandomAffirmation": "get_random_affirmation",
}
