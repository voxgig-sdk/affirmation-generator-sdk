# AffirmationGenerator SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from affirmationgenerator_sdk import AffirmationGeneratorSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"AffirmationGeneratorSDK": AffirmationGeneratorSDK, "os": os}
        try:
