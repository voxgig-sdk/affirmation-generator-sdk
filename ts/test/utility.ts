...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.AFFIRMATIONGENERATOR_TEST_LIVE ||
    'TRUE' === process.env.AFFIRMATIONGENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.AFFIRMATIONGENERATOR_TEST_EXPLAIN = process.env.AFFIRMATIONGENERATOR_TEST_EXPLAIN || m.AFFIRMATIONGENERATOR_TEST_EXPLAIN
