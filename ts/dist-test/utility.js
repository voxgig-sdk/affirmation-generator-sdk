...
function envOverride(m) {
    if ('TRUE' === process.env.AFFIRMATION_GENERATOR_TEST_LIVE ||
        'TRUE' === process.env.AFFIRMATION_GENERATOR_TEST_OVERRIDE) {
    ...
    m.AFFIRMATION_GENERATOR_TEST_EXPLAIN = process.env.AFFIRMATION_GENERATOR_TEST_EXPLAIN || m.AFFIRMATION_GENERATOR_TEST_EXPLAIN;
    return m;
}
