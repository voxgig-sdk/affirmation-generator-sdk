...
(0, node_test_1.describe)('GetRandomAffirmationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AffirmationGeneratorSDK({
    ...
    (0, node_test_1.test)('direct-load-get_random_affirmation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_random_affirmation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AFFIRMATION_GENERATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AffirmationGeneratorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['AFFIRMATION_GENERATOR_TEST_GET_RANDOM_AFFIRMATION_ENTID'];
    ...
    const client = new __1.AffirmationGeneratorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetRandomAffirmationDirect.test.js.map