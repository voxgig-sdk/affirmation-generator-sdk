...
local GetRandomAffirmationEntity = {}
GetRandomAffirmationEntity.__index = GetRandomAffirmationEntity


function GetRandomAffirmationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomAffirmationEntity)
  self._name = "get_random_affirmation"
  self._client = client
...
function GetRandomAffirmationEntity:get_name()
  return self._name
end


function GetRandomAffirmationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomAffirmationEntity.new(self._client, opts)
end
...
function GetRandomAffirmationEntity:mark_deleted()
  self._deleted = true
end


function GetRandomAffirmationEntity:deleted()
  return true == self._deleted
end


function GetRandomAffirmationEntity:data_set(args)
  if args ~= nil then
...
function GetRandomAffirmationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomAffirmationEntity:match_set(args)
  if args ~= nil then
...
function GetRandomAffirmationEntity:match_get()
...
function GetRandomAffirmationEntity:stream(action, args, callopts)
...
function GetRandomAffirmationEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetRandomAffirmationEntity
