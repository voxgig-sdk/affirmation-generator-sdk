...
function runner.env_override(m)
  local live = runner.getenv("AFFIRMATIONGENERATOR_TEST_LIVE")
  local override = runner.getenv("AFFIRMATIONGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AFFIRMATIONGENERATOR_TEST_EXPLAIN")
