...
function runner.env_override(m)
  local live = runner.getenv("AFFIRMATION_GENERATOR_TEST_LIVE")
  local override = runner.getenv("AFFIRMATION_GENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("AFFIRMATION_GENERATOR_TEST_EXPLAIN")
