...
// AffirmationGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AffirmationGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'AffirmationGeneratorSDK';
    ...
    private const SDK_BASE = 'affirmationgenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../affirmationgenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
