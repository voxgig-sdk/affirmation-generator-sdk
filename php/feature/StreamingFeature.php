...
// AffirmationGenerator SDK streaming feature
...
class AffirmationGeneratorStreamingFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _iterate(AffirmationGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(AffirmationGeneratorContext $ctx): bool
    {
