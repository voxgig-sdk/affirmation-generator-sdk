...
// AffirmationGenerator SDK rbac feature
...
class AffirmationGeneratorRbacFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _required(AffirmationGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(AffirmationGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(AffirmationGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
