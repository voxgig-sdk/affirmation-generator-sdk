...
// AffirmationGenerator SDK netsim feature
...
class AffirmationGeneratorNetsimFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _simulate(AffirmationGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AffirmationGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
