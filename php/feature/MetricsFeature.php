...
// AffirmationGenerator SDK metrics feature
...
class AffirmationGeneratorMetricsFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _record(AffirmationGeneratorContext $ctx, bool $ok): void
    {
