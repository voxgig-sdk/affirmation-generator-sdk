...
// AffirmationGenerator SDK paging feature
...
class AffirmationGeneratorPagingFeature extends AffirmationGeneratorBaseFeature
{
    ...
    private function _is_list(AffirmationGeneratorContext $ctx): bool
    {
