...
// AffirmationGenerator SDK proxy feature
...
class AffirmationGeneratorProxyFeature extends AffirmationGeneratorBaseFeature
{
    ...
    public function init(AffirmationGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AffirmationGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
