...
class AffirmationGeneratorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AffirmationGeneratorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AffirmationGeneratorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AffirmationGeneratorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AffirmationGeneratorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AffirmationGeneratorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AffirmationGeneratorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AffirmationGeneratorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AffirmationGeneratorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AffirmationGeneratorError($op . "_allow",
                "AffirmationGeneratorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AffirmationGeneratorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AffirmationGeneratorError("graphql_error",
                "AffirmationGeneratorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetRandomAffirmation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_random_affirmation === null) {
                $this->_get_random_affirmation = new GetRandomAffirmationEntity($this, null);
            }
            return $this->_get_random_affirmation;
        }
        return new GetRandomAffirmationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AffirmationGeneratorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
