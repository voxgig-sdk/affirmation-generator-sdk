...
// AffirmationGenerator SDK utility: fetcher

class AffirmationGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AffirmationGeneratorSDK/1.0)';
    ...
    public static function call(AffirmationGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {
