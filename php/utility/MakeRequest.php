...
// AffirmationGenerator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AffirmationGeneratorMakeRequest
{
    public static function call(AffirmationGeneratorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AffirmationGeneratorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AffirmationGeneratorResponse($fetched);
        } else {
