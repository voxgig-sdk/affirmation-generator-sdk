...
// AffirmationGenerator SDK utility: graphql
//
...
class AffirmationGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(AffirmationGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(AffirmationGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
