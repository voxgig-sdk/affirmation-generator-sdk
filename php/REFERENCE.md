# AffirmationGenerator PHP SDK Reference

Complete API reference for the AffirmationGenerator PHP SDK.
...
#### `AffirmationGeneratorSDK::test($testopts = null, $sdkopts = null)`
...
#### `GetRandomAffirmation($data = null)`
...
#### `make(): GetRandomAffirmationEntity`
