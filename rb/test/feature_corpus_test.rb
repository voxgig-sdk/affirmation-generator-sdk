# AffirmationGenerator SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # AffirmationGeneratorSDK.new, not AffirmationGeneratorSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    AffirmationGeneratorSDK.new(opts)
  end
