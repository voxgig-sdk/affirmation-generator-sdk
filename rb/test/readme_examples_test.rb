...
#      offline in seeded test mode (AffirmationGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AffirmationGenerator_sdk.rb")
  SDK_CLASS = "AffirmationGeneratorSDK"
  ...
  SDK_BASE = "AffirmationGenerator_sdk"
