...
type AffirmationGeneratorSDK struct {
	Mode     string
...
func (sdk *AffirmationGeneratorSDK) OptionsMap() map[string]any {
...
func (sdk *AffirmationGeneratorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AffirmationGeneratorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AffirmationGeneratorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AffirmationGeneratorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AffirmationGeneratorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AffirmationGeneratorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AffirmationGeneratorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AffirmationGeneratorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AffirmationGeneratorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AffirmationGeneratorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *AffirmationGeneratorSDK {
	...
	sdk := NewAffirmationGeneratorSDK(sdkopts)
	sdk.Mode = "test"
