...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("AFFIRMATIONGENERATOR_TEST_LIVE") == "TRUE" ||
		os.Getenv("AFFIRMATIONGENERATOR_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("AFFIRMATIONGENERATOR_TEST_EXPLAIN"); explain != "" {
