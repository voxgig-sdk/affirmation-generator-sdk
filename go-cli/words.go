...
func registerSDKWords(r *eng.Registry, client *sdk.AffirmationGeneratorSDK) {
...
func runOp(client *sdk.AffirmationGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
