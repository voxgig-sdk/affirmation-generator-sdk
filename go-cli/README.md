...
AQL-driven CLI and REPL for the AffirmationGenerator SDK. Positional arguments are
...
```sh
go build -o affirmation-generator-cli ./...
```
...
./affirmation-generator-cli list get_random_affirmation
./affirmation-generator-cli load 1 get_random_affirmation
./affirmation-generator-cli load '{id:1}' get_random_affirmation
