...
AQL-driven command-line client **and** interactive REPL for the AffirmationGenerator
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `get_random_affirmation`).
