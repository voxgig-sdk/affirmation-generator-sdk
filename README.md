...
This API provides inspirational affirmations to boost positivity and self-esteem.

Learn more about Affirmation Generator API at [affirmations.dev](https://affirmations.dev).
...
This SDK exposes the API as a small set of **semantic entities** — GetRandomAffirmation — that you
...
$client = AffirmationGeneratorSDK::test([
    "entity" => ["getrandomaffirmation" => ["test01" => []]],
]);
$getrandomaffirmation = $client->GetRandomAffirmation()->load();
```
...
| --- | --- | --- |
| **GetRandomAffirmation** | The GetRandomAffirmation entity (load). | `/` |
