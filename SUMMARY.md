...
Results: Successful response with a random affirmation.
...
| --- | --- | --- | --- |
| GetRandomAffirmation | `load` | `GET /` | See reference |

## Connect to the API

- Production server: `https://www.affirmations.dev`
...
- `affirmation-generator_list`: List records for an entity. No active entity supports this operation.
- `affirmation-generator_load`: Load one record for an entity. Supported entities: `get_random_affirmation`.
